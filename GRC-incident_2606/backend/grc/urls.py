...
# Authentication URLs
auth_urlpatterns = [
    path('login/', risk_views.login, name='login'),
    path('register/', risk_views.register, name='register'),
    path('test-connection/', risk_views.test_connection, name='test-connection'),
]

# Add explicit URL paths for the ViewSets
...
incident_urlpatterns = [
    ...
    path('api/risks-for-dropdown/', risk_views.get_all_risks_for_dropdown, name='risks-for-dropdown'),
    path('api/compliances-for-dropdown/', risk_views.get_all_compliances_for_dropdown, name='compliances-for-dropdown'),
    path('api/users-for-dropdown/', risk_views.get_users_for_dropdown, name='users-for-dropdown'),
...
urlpatterns = [
    ...
    path('incidents/', incident_views.list_incidents, name='api-list-incidents'),
    ...
    path('users/', incident_views.list_users, name='list-users'),
...
#
    ...
    path('policy-approvals/rejected/<int:user_id>/', list_rejected_policy_approvals_for_user),
    ...
    path('frameworks/<int:framework_id>/policies/', compliance_views.get_policies, name='get-policies'),
    ...
    path('api/audits/<int:audit_id>/status/', audit_views.update_audit_status, name='update_audit_status'),
    path('api/audits/<int:audit_id>/update-review-status/', reviewing.update_review_status, name='update_review_status'),
    ...
    # Compliance endpoints
    path('compliance/', audit_views.get_all_compliance, name='get_all_compliance'),
    path('subpolicies/<int:subpolicy_id>/compliance/', audit_views.get_compliance_by_subpolicy, name='get_compliance_by_subpolicy'),
    ...
    path('add-majorminor-column/', audit_views.add_majorminor_column, name='add_majorminor_column'),
    
    # Fixed subpolicy version field
    path('fix-subpolicy-version/', audit_views.fix_subpolicy_version_field, name='fix_subpolicy_version_field'),
    path('fix-audit-table/', audit_views.fix_audit_table, name='fix_audit_table'),
    ...
    path('audits/<int:audit_id>/debug-status-transition/', audit_views.debug_audit_status_transition, name='debug_audit_status_transition'),

    # New debug endpoint
    path('debug/audit-version-schema/', audit_views.debug_audit_version_schema, name='debug_audit_version_schema'),
