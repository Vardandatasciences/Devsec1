...
try:
    db_pool = mysql.connector.pooling.MySQLConnectionPool(
        ...
        database=os.environ.get('DB_NAME', 'incident')
    )
except mysql.connector.Error as e:
    db_pool = None
    print(f"Warning: Could not create MySQL connection pool: {str(e)}")
    print("Database export features will be disabled.")
...
def get_db_connection():
    ...
    if db_pool is None:
        raise RuntimeError("MySQL connection pool is not available. Database export features are disabled.")
