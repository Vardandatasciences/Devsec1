  ...
  <div class="task-view">
    ...
    <div v-else-if="auditDetails" class="audit-content">
          ...
          <div v-if="selectedCompliance" class="compliance-details">
            ...
            <div class="compliance-row">
              <div class="form-group">
                ...
                <select v-model="selectedCompliance.status" disabled class="form-control">
              ...
              <div class="form-group">
                ...
                <select v-model="selectedCompliance.major_minor" disabled class="form-control">
            ...
            <div class="compliance-row">
              <div class="form-group">
                ...
                <textarea v-model="selectedCompliance.what_to_verify" disabled class="form-control"></textarea>
              </div>
              <div class="form-group">
                <label>How to Verify</label>
                <textarea v-model="selectedCompliance.how_to_verify" disabled class="form-control"></textarea>
              </div>
              <div class="form-group">
                <label>Impact</label>
                <textarea v-model="selectedCompliance.impact" disabled class="form-control"></textarea>
              </div>
            </div>
            ...
            <div class="compliance-row">
              <div class="form-group">
                ...
                <textarea v-model="selectedCompliance.why_to_verify" disabled class="form-control"></textarea>
              </div>
              <div class="form-group">
                <label>Details of Findings</label>
                <textarea v-model="selectedCompliance.details_of_finding" disabled class="form-control"></textarea>
              </div>
              <div class="form-group">
                <label>Underlying Cause</label>
                <textarea v-model="selectedCompliance.underlying_cause" disabled class="form-control"></textarea>
              </div>
            </div>
            ...
            <div class="compliance-row">
              <div class="form-group">
                ...
                <select v-model="selectedCompliance.selected_risks" class="form-control" multiple disabled>
            ...
            <div class="compliance-row">
              <div class="form-group">
                ...
                <textarea v-model="selectedCompliance.suggested_action_plan" disabled class="form-control"></textarea>
              </div>
              <div class="form-group small-input">
                <label>Responsible for Plan</label>
                <input type="text" v-model="selectedCompliance.responsible_for_plan" disabled class="form-control">
              </div>
              <div class="form-group">
                <label>Mitigation Date</label>
                <input type="date" v-model="selectedCompliance.mitigation_date" disabled class="form-control">
              </div>
            </div>
            ...
            <div class="compliance-row">
              ...
              <div class="form-group" v-if="selectedCompliance.re_audit">
                ...
                <input type="date" v-model="selectedCompliance.re_audit_date" disabled class="form-control">
              </div>
              <div class="form-group">
                <label>Comments</label>
                <textarea v-model="selectedCompliance.comments" disabled class="form-control"></textarea>
              </div>
            </div>

            <!-- Review Status and Comments -->
            <div class="compliance-row review-section">
              <div class="form-group">
                <label>Review Status</label>
                <select v-model="selectedCompliance.review_status" class="form-control">
              ...
              <div class="form-group">
                ...
                <textarea v-model="selectedCompliance.review_comments" class="form-control"></textarea>
              </div>
            </div>
      ...
      <div class="floating-save-container">
        <button @click="saveReview" class="floating-save-button" :disabled="isSavingReview">
    ...
    <!-- Modals -->
    <div v-if="showRejectModal" class="modal-overlay" @click="keepEditing">
      <div class="modal-content" @click.stop>
        <div class="modal-header">
          <h3>Confirm Rejection</h3>
          <button @click="keepEditing" class="close-button">&times;</button>
        </div>
        ...
        <div class="modal-footer">
          <button @click="keepEditing" class="btn-secondary">Keep Editing</button>
    ...
    <div v-if="showAcceptModal" class="modal-overlay" @click="keepEditing">
      <div class="modal-content" @click.stop>
        <div class="modal-header">
        ...
        <div class="modal-footer">
          <button @click="keepEditing" class="btn-secondary">Keep Editing</button>
          <button @click="confirmAccept" class="btn-primary">
            Yes, Complete Review
          </button>
        </div>
      </div>
...
.overall-comments-section h3,
.overall-review-comments-section h3 {
  color: #2c3e50;
  margin: 0 0 15px 0;
}
