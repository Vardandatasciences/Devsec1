<template>
  <div class="task-view">
    ...
    <div v-else-if="auditDetails" class="audit-content">
      <div class="audit-details">
        ...
        <div class="compliance-section">
          <div class="compliance-header-row">
            ...
            <button @click="showAddComplianceModal = true" class="add-compliance-button">
          ...
          <div class="compliance-tabs">
            <button 
              ...
              :key="compliance.id"
              :class="['tab-button', { active: selectedComplianceIndex === index }]"
          ...
          <div v-if="selectedCompliance" class="compliance-details">
            ...
            <div class="compliance-row">
              <div class="form-group">
                ...
                <select v-model="selectedCompliance.status" @change="onFieldChange" class="form-control">
                  <option value="2">Fully Compliant</option>
                  <option value="1">Partially Compliant</option>
                  <option value="0">Not Compliant</option>
                  <option value="3">Not Applicable</option>
                </select>
                <div v-if="getFieldError('status', selectedComplianceIndex)" class="error-message">
                  {{ getFieldError('status', selectedComplianceIndex) }}
                </div>
              </div>
              <div class="form-group">
                <label>Type of Findings</label>
                <select v-model="selectedCompliance.major_minor" @change="onFieldChange" class="form-control">
              ...
              <div class="form-group">
                ...
                <input 
                  ...
                  class="form-control"
                >
                <div v-if="getFieldError('severity_rating', selectedComplianceIndex)" class="error-message">
            ...
            <div class="compliance-row">
              <div class="form-group">
                ...
                <textarea v-model="selectedCompliance.what_to_verify" @input="onFieldChange" class="form-control"></textarea>
              </div>
              <div class="form-group">
                <label>How to Verify</label>
                <textarea v-model="selectedCompliance.how_to_verify" @input="onFieldChange" class="form-control"></textarea>
              </div>
              <div class="form-group">
                <label>Impact</label>
                <textarea v-model="selectedCompliance.impact" @input="onFieldChange" class="form-control"></textarea>
              </div>
            </div>
            ...
            <div class="compliance-row">
              <div class="form-group">
                ...
                <textarea v-model="selectedCompliance.why_to_verify" @input="onFieldChange" class="form-control"></textarea>
              </div>
              <div class="form-group">
                <label>Details of Findings</label>
                <textarea v-model="selectedCompliance.details_of_finding" @input="onFieldChange" class="form-control"></textarea>
              </div>
              <div class="form-group">
                <label>Underlying Cause</label>
                <textarea v-model="selectedCompliance.underlying_cause" @input="onFieldChange" class="form-control"></textarea>
              </div>
            </div>
            ...
            <div class="compliance-row">
              <div class="form-group">
                ...
                <select v-model="selectedCompliance.selected_risks" class="form-control" multiple @change="updateCorrectiveActions">
              ...
              <div class="form-group">
                ...
                <div v-if="selectedCompliance.selected_risks && selectedCompliance.selected_risks.length > 0"
                     class="corrective-actions-container">
            ...
            <div class="compliance-row">
              <div class="form-group">
                ...
                <textarea v-model="selectedCompliance.suggested_action_plan" @input="onFieldChange" class="form-control"></textarea>
              </div>
              <div class="form-group small-input">
                <label>Responsible for Plan</label>
                <input type="text" v-model="selectedCompliance.responsible_for_plan" @input="onFieldChange" class="form-control">
              </div>
              <div class="form-group">
                <label>Mitigation Date</label>
                <input type="date" v-model="selectedCompliance.mitigation_date" @change="onFieldChange" class="form-control">
              </div>
            </div>
            ...
            <div class="compliance-row">
              ...
              <div class="form-group" v-if="selectedCompliance.re_audit">
                <label>Re-audit Date</label>
                <input type="date" v-model="selectedCompliance.re_audit_date" @change="onFieldChange" class="form-control">
              </div>
              <div class="form-group">
                <label>Comments</label>
                <textarea v-model="selectedCompliance.comments" @input="onFieldChange" class="form-control"></textarea>
              </div>
            </div>
            ...
            <div class="compliance-row">
              <div class="form-group">
                ...
                <select v-model="selectedCompliance.review_status" disabled class="form-control disabled">
              ...
              <div class="form-group">
                ...
                <textarea v-model="selectedCompliance.review_comments" disabled class="form-control disabled" placeholder="Review comments will appear here..."></textarea>
              </div>
            </div>
              ...
              <div class="form-group">
                ...
                <div class="upload-container">
                  <input 
                    ...
                    style="display: none"
                  >
                  <button @click="$refs.complianceFileInput.click()" class="upload-button">
                    Upload Compliance Evidence
                  </button>
                  <div v-if="selectedCompliance.evidence_files && selectedCompliance.evidence_files.length > 0" class="uploaded-files">
                    <div v-for="(file, index) in selectedCompliance.evidence_files" :key="index" class="file-item" :class="{ 'from-version': file.fromVersion }">
                      <span class="file-name">{{ file.name }}</span>
                      <span v-if="file.fromVersion" class="version-badge-small">From Version</span>
                      <a v-if="file.url" :href="file.url" target="_blank" class="view-file-btn" title="View File">👁️</a>
                      <button @click="removeComplianceFile(index)" class="remove-file-btn">×</button>
                    </div>
                  </div>
                  <div v-if="complianceUploadProgress > 0 && complianceUploadProgress < 100" class="upload-progress">
                    <div class="progress-bar">
                      <div class="progress-fill" :style="{ width: complianceUploadProgress + '%' }"></div>
                    </div>
          ...
          <div class="floating-save-container">
            <button @click="saveCompliance" class="floating-save-button" :disabled="isSaving">
      ...
      <div class="audit-evidence-section">
        ...
        <div class="upload-container">
          <input 
            ...
            style="display: none"
          >
          <button @click="$refs.auditFileInput.click()" class="upload-button audit-upload">
            Upload Audit Evidence
          </button>
          <div v-if="auditEvidenceFiles && auditEvidenceFiles.length > 0" class="uploaded-files">
            <div v-for="(file, index) in auditEvidenceFiles" :key="index" class="file-item" :class="{ 'from-version': file.fromVersion }">
              <span class="file-name">{{ file.name }}</span>
              <span v-if="file.fromVersion" class="version-badge-small">From Version</span>
              <a v-if="file.url" :href="file.url" target="_blank" class="view-file-btn" title="View File">👁️</a>
              <button @click="removeAuditFile(index)" class="remove-file-btn">×</button>
            </div>
          </div>
          <div v-if="auditUploadProgress > 0 && auditUploadProgress < 100" class="upload-progress">
            <div class="progress-bar">
              <div class="progress-fill" :style="{ width: auditUploadProgress + '%' }"></div>
            </div>
      ...
      <div class="overall-comments-section">
        ...
        <div class="form-group">
          <textarea 
            ...
            @input="onFieldChange"
            class="form-control overall-comments-textarea"
      ...
      <div class="overall-review-comments-section">
      ...
      <div class="version-info" v-if="currentVersion">
        <div class="version-badge">
          ...
          <span class="version-type">{{ getVersionType(currentVersion) }}</span>
        </div>
        <div class="last-saved" v-if="lastSavedTime">
          <span class="saved-label">Last Saved:</span>
          <span class="saved-time">{{ formatDateTime(lastSavedTime) }}</span>
        </div>
      </div>
      <div class="version-info" v-else>
        <div class="version-badge">
          <span class="version-label">Status:</span>
          <span class="version-number new-audit">New Audit</span>
          <span class="version-type">No versions saved yet</span>
        </div>
      </div>
    </div>
    ...
    <div v-if="showReviewModal" class="modal-overlay" @click="closeReviewModal">
      <div class="modal-content" @click.stop>
        ...
        <div class="modal-footer">
          <button @click="keepEditing" class="btn-secondary">No, Keep Editing</button>
          <button @click="sendForReview" class="btn-primary" :disabled="isSendingForReview">
    ...
    <div v-if="showAddComplianceModal" class="modal-overlay" @click="closeAddComplianceModal">
      <div class="modal-content add-compliance-modal" @click.stop>
        <div class="modal-header">
          <h3>Add New Compliance</h3>
          <button @click="closeAddComplianceModal" class="close-button">×</button>
        </div>
        <div class="modal-body">
          <form @submit.prevent="submitNewCompliance">
            <div class="form-row">
              <div class="form-group">
                ...
                <input type="text" v-model="newCompliance.identifier" required class="form-control">
                <div v-if="getFieldError('identifier')" class="error-message">
                  {{ getFieldError('identifier') }}
                </div>
              </div>
              <div class="form-group">
                <label>Compliance Title*</label>
                <input type="text" v-model="newCompliance.complianceTitle" required class="form-control">
                <div v-if="getFieldError('complianceTitle')" class="error-message">
            ...
            <div class="form-group">
              ...
              <textarea v-model="newCompliance.complianceItemDescription" required class="form-control" rows="3"></textarea>
            </div>
            
            <div class="form-row">
              <div class="form-group">
                <label>Compliance Type*</label>
                <input type="text" v-model="newCompliance.complianceType" required class="form-control">
              </div>
              <div class="form-group">
                <label>Scope*</label>
                <input type="text" v-model="newCompliance.scope" required class="form-control">
              </div>
            </div>
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <textarea v-model="newCompliance.objective" required class="form-control" rows="2"></textarea>
              </div>
              <div class="form-group">
                <label>Impact</label>
                <textarea v-model="newCompliance.impact" class="form-control" rows="2"></textarea>
              </div>
            </div>
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <textarea v-model="newCompliance.possibleDamage" class="form-control" rows="2"></textarea>
              </div>
              <div class="form-group">
        ...
        <div class="modal-footer">
          <button @click="closeAddComplianceModal" class="btn-secondary">Cancel</button>
          <button @click="submitNewCompliance" class="btn-primary" :disabled="isAddingCompliance">
  ...
  methods: {
    ...
    async handleComplianceFileUpload(event) {
      ...
      try {
        ...
        this.selectedCompliance.evidence_urls = uploadedUrls.join(',');
    ...
    async handleAuditFileUpload(event) {
      ...
      try {
        ...
        this.auditDetails.evidence_urls = uploadedUrls.join(',');
...
.status-completed { background: #badc58; color: #2f3640; }
.status-progress { background: #7ed6df; color: #2f3640; }
