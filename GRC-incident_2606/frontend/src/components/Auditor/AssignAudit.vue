      ...
      <div v-if="currentTab === 0" class="tab-content">
        ...
        <div class="dynamic-fields-row">
          <div class="dynamic-field-col">
            ...
            <select v-model="auditData.framework" class="dynamic-input" @change="onFrameworkChange">
              <option value="">Select Framework</option>
              <option v-for="fw in frameworks" :key="fw.FrameworkId" :value="fw.FrameworkId">{{ fw.FrameworkName }}</option>
            </select>
            <div v-if="getFieldError('framework')" class="error-message">
              {{ getFieldError('framework') }}
            </div>
        ...
        <div v-for="(member, index) in teamMembers" :key="index" class="team-member-card">
          <div class="dynamic-fields-row">
            <div class="dynamic-field-col">
              ...
              <select v-model="member.auditor" class="dynamic-input">
                <option value="">Select Auditor</option>
                <option v-for="user in users" :key="user.UserId" :value="user.UserId">{{ user.UserName }}</option>
              </select>
              <div v-if="getFieldError('auditor', index)" class="error-message">
                {{ getFieldError('auditor', index) }}
              </div>
            </div>
            <div class="dynamic-field-col">
              <label class="dynamic-label">Role</label>
              <div class="dynamic-desc">Select the role of the auditor in this audit.</div>
              <select v-model="member.role" class="dynamic-input">
                <option value="">Select Role</option>
                <option v-for="role in roles" :key="role" :value="role">{{ role }}</option>
              </select>
              <div v-if="getFieldError('role', index)" class="error-message">
            ...
            <div class="dynamic-field-col">
              ...
              <textarea v-model="member.responsibilities" class="dynamic-input" rows="3" placeholder="Enter responsibilities..."></textarea>
              <div v-if="getFieldError('responsibilities', index)" class="error-message">
              ...
              <div class="section-content" :class="{ 'collapsed': !member.isPolicyAssignmentExpanded }">
                <div class="dynamic-fields-row">
                  <div class="dynamic-field-col">
                    ...
                    <select v-model="member.assignedPolicy" class="dynamic-input" @change="onMemberPolicyChange(index)">
                      <option value="">Select Policy</option>
                      <option v-for="p in policies" :key="p.PolicyId" :value="p.PolicyId">{{ p.PolicyName }}</option>
                    </select>
                    <div v-if="getFieldError('assignedPolicy', index)" class="error-message">
                      {{ getFieldError('assignedPolicy', index) }}
                    </div>
                  </div>
                  <div class="dynamic-field-col">
                    <label class="dynamic-label">Sub Policy</label>
                    <div class="dynamic-desc">Select specific sub policy if applicable.</div>
                    <select v-model="member.assignedSubPolicy" class="dynamic-input" @change="onSubPolicyChange(index)">
                      <option value="">Select Sub Policy</option>
                      <option v-for="sp in getMemberSubpolicies(index)" :key="sp.SubPolicyId" :value="sp.SubPolicyId">
                        {{ sp.SubPolicyName }}
                      </option>
                    </select>
                  </div>
                  <div class="dynamic-field-col">
                    ...
                    <select v-model="member.reviewer" class="dynamic-input">
                      <option value="">Select Reviewer</option>
                      <option v-for="user in users" :key="user.UserId" :value="user.UserId">{{ user.UserName }}</option>
                    </select>
                    <div v-if="getFieldError('reviewer', index)" class="error-message">
                      {{ getFieldError('reviewer', index) }}
                    </div>
                  </div>
                </div>
              ...
              <div class="section-content" :class="{ 'collapsed': !member.isAuditDetailsExpanded }">
                <div class="dynamic-fields-row">
                  <div class="dynamic-field-col">
                    ...
                    <div v-if="getFieldError('auditTitle', index)" class="error-message">
                      {{ getFieldError('auditTitle', index) }}
                    </div>
                  </div>
                  <div class="dynamic-field-col">
                    ...
                    <div v-if="getFieldError('businessUnit', index)" class="error-message">
                      {{ getFieldError('businessUnit', index) }}
                    </div>
                  </div>
                </div>
                ...
                <div class="dynamic-fields-row">
                  <div class="dynamic-field-col">
                    ...
                    <textarea v-model="member.scope" class="dynamic-input dynamic-textarea" placeholder="Enter scope..." rows="3"></textarea>
                    <div v-if="getFieldError('scope', index)" class="error-message">
                  ...
                  <div class="dynamic-field-col">
                    ...
                    <textarea v-model="member.objective" class="dynamic-input dynamic-textarea" placeholder="Enter objective..." rows="3"></textarea>
                    <div v-if="getFieldError('objective', index)" class="error-message">
                ...
                <div class="dynamic-fields-row">
                  <div class="dynamic-field-col">
                    ...
                    <select v-model="member.type" class="dynamic-input">
                      <option value="">Select Type</option>
                      <option value="I">Internal</option>
                      <option value="E">External</option>
                      <option value="S">Self-Audit</option>
                    </select>
                    <div v-if="getFieldError('type', index)" class="error-message">
                      {{ getFieldError('type', index) }}
                    </div>
                  </div>
                  <div class="dynamic-field-col">
                    <label class="dynamic-label">Frequency</label>
                    <div class="dynamic-desc">How often should this audit occur?</div>
                    <select v-model="member.frequency" class="dynamic-input">
                      ...
                      <option value="365a">Annually</option>
                    </select>
                    <div v-if="getFieldError('frequency', index)" class="error-message">
                      {{ getFieldError('frequency', index) }}
                    </div>
                  </div>
                  <div class="dynamic-field-col">
                    <label class="dynamic-label">Due Date</label>
                    <div class="dynamic-desc">Select the due date for this audit.</div>
                    <input type="date" v-model="member.dueDate" class="dynamic-input" />
                    <div v-if="getFieldError('dueDate', index)" class="error-message">
                      {{ getFieldError('dueDate', index) }}
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div v-for="(member, index) in teamMembers" :key="index" class="summary-card">
            ...
            <div class="review-section">
              ...
              <div class="review-section-content" :class="{ 'collapsed': !member.isReviewPolicyExpanded }">
                <!-- Read-only mode -->
                <div v-if="!member.isPolicyEditMode" class="readonly-view">
                  <div class="readonly-fields-row">
                    <div class="readonly-field">
                      <div class="readonly-label">Assigned Policy</div>
                      <div class="readonly-value">{{ getPolicyName(member.assignedPolicy) }}</div>
                    </div>
                    <div class="readonly-field" v-if="member.assignedSubPolicy">
                      <div class="readonly-label">Sub Policy</div>
                      <div class="readonly-value">{{ getSubPolicyName(member.assignedSubPolicy) }}</div>
                    </div>
                    <div class="readonly-field">
                      <div class="readonly-label">Reviewer</div>
                      <div class="readonly-value">{{ getUserName(member.reviewer) }}</div>
                    </div>
                    <div class="readonly-field">
                      <div class="readonly-label">Compliance Items</div>
                      <div class="readonly-value">{{ getComplianceCount(member.assignedPolicy, member.assignedSubPolicy) }}</div>
                    </div>
                  </div>
                  
                  <!-- Display Selected Reports in read-only mode -->
                  <div v-if="getSelectedReportsForMember(member).length > 0" class="readonly-reports">
                    <div class="readonly-label">Selected Reports</div>
                    <div class="readonly-reports-list">
                      <div v-for="report in getSelectedReportsForMember(member)" 
                           :key="report.ReportId" 
                           class="readonly-report-item">
                        <span class="report-title">Report #{{ report.ReportId }}</span>
                        <span class="report-info">
                          {{ report.AuditorName }} - {{ formatDate(report.CompletionDate) }}
                        </span>
            ...
            <div class="review-section">
              ...
              <div class="review-section-content" :class="{ 'collapsed': !member.isReviewDetailsExpanded }">
                <!-- Read-only mode -->
                <div v-if="!member.isDetailsEditMode" class="readonly-view">
                  <div class="readonly-fields-row">
                    <div class="readonly-field">
                      <div class="readonly-label">Audit Title</div>
                      <div class="readonly-value">{{ member.auditTitle }}</div>
                    </div>
                    <div class="readonly-field">
                      <div class="readonly-label">Business Unit</div>
                      <div class="readonly-value">{{ member.businessUnit }}</div>
                    </div>
                  </div>
                  
                  <div class="readonly-fields-row">
                    <div class="readonly-field">
                      <div class="readonly-label">Scope</div>
                      <div class="readonly-value readonly-text">{{ member.scope }}</div>
                    </div>
                    <div class="readonly-field">
                      <div class="readonly-label">Objective</div>
                      <div class="readonly-value readonly-text">{{ member.objective }}</div>
                    </div>
                  </div>
                  ...
                  <div class="readonly-fields-row">
                    <div class="readonly-field">
                      ...
                      <div class="readonly-value">{{ getAuditTypeLabel(member.type) }}</div>
                    </div>
                    <div class="readonly-field">
                      <div class="readonly-label">Frequency</div>
                      <div class="readonly-value">{{ getFrequencyLabel(member.frequency) }}</div>
                    </div>
                    <div class="readonly-field">
                      <div class="readonly-label">Due Date</div>
                      <div class="readonly-value">{{ formatDate(member.dueDate) }}</div>
                    </div>
                  </div>
                  ...
                  <div class="readonly-fields-row">
                    <div class="readonly-field">
                      ...
                      <div class="readonly-value">{{ member.role }}</div>
                    </div>
                    <div class="readonly-field">
                      <div class="readonly-label">Responsibilities</div>
                      <div class="readonly-value readonly-text">{{ member.responsibilities }}</div>
                    </div>
                  </div>
                </div>
                ...
                <div v-else class="edit-view">
                  ...
                  <div class="dynamic-fields-row">
                    ...
                    <div class="dynamic-field-col">
                      ...
                      <textarea v-model="member.responsibilities" class="dynamic-input dynamic-textarea" placeholder="Enter responsibilities..." rows="3"></textarea>
                    </div>
                  </div>
                </div>
              </div>
