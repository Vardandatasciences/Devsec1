  ...
  <div class="tailoring-container">
    ...
    <div class="dropdown-container">
      <div v-if="!showPolicyDropdown" class="filter-group">
        ...
        <div class="select-wrapper" title="Choose an existing framework to copy and customize">
    ...
    <div v-if="showPolicyDropdown" class="filter-group">
      ...
      <div class="select-wrapper" title="Choose an approved and active policy to copy to another framework">
          ...
          <form class="form-section" @submit.prevent="submitFrameworkForm">
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <input type="text" v-model="frameworkData.identifier" required title="Enter a unique identifier or code for this framework" />
              </div>
            </div>
          ...
          <form class="form-section policy-form" @submit.prevent="submitFrameworkForm">
            ...
            <div v-if="!showPolicyDropdown && stepIndex > 0 && policiesData[stepIndex - 1]" class="policy-form-container">
              ...
              <div class="form-row">
                <div class="form-group">
                  <label>Title</label>
                  <input type="text" v-model="policiesData[stepIndex - 1].title" :required="!policiesData[stepIndex - 1].exclude" placeholder="Enter policy title" title="Enter a clear and descriptive name for this policy" />
                </div>
                <div class="form-group">
                  <label>Description</label>
              ...
              <div class="form-row">
                ...
                <div class="form-group">
                  <label>Identifier</label>
                  <input type="text" v-model="policiesData[stepIndex - 1].identifier" :required="!policiesData[stepIndex - 1].exclude" placeholder="Enter identifier" title="Enter a unique identifier or code for this policy" />
                </div>
              </div>
              <div class="form-row">
                <div class="form-group">
                ...
                <div class="subpolicies-row">
                  <div v-for="(sub, subIdx) in policiesData[stepIndex - 1].subPolicies" :key="subIdx" class="subpolicy-card">
                    ...
                    <div class="form-group" :class="{ 'excluded': sub.exclude }">
                      <label>Title</label>
                      <input type="text" v-model="sub.title" required :disabled="sub.exclude" placeholder="Enter sub-policy title" title="Enter a descriptive name for this sub-policy" />
                    </div>
                    <div class="form-group" :class="{ 'excluded': sub.exclude }">
                      <label>Description</label>
                    ...
                    <div class="form-group" :class="{ 'excluded': sub.exclude }">
                      <label>Identifier</label>
                      <input type="text" v-model="sub.identifier" required :disabled="sub.exclude" placeholder="Enter identifier" title="Enter a unique identifier or code for this sub-policy" />
                    </div>
                  </div>
                </div>
            ...
            <div v-if="showPolicyDropdown">
              <div v-if="showPolicyDropdown && policiesData[stepIndex]" class="policy-form-container">
                ...
                <div class="form-row">
                  <div class="form-group">
                    <label>Title</label>
                    <input type="text" v-model="policiesData[stepIndex].title" :required="!policiesData[stepIndex].exclude" placeholder="Enter policy title" title="Enter a clear and descriptive name for this policy" />
                  </div>
                  <div class="form-group">
                    <label>Description</label>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group">
                    <label>Identifier</label>
                    <input type="text" v-model="policiesData[stepIndex].identifier" :required="!policiesData[stepIndex].exclude" placeholder="Enter identifier" title="Enter a unique identifier or code for this policy" />
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-group">
