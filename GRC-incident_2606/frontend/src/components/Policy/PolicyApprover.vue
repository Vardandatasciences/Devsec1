    ...
    fetchPolicies() {
      ...
      axios.get('http://localhost:8000/api/policy-approvals/reviewer/')
        .then(response => {
          ...
          const approvals = response.data.map(approval => {
            return {
      ...
      if (!this.isComplianceApproval) {
        ...
        axios.get(`http://localhost:8000/api/policies/${policyId}/version/`)
          ...
          .catch(error => {
            ...
            alert('Error getting policy version: ' + (error.response?.data?.error || error.message));
          });
    ...
    resubmitPolicy(policy) {
      ...
      axios.put(`http://localhost:8000/api/policies/${policyId}/resubmit-approval/`, resubmitData)
        .then(response => {
          ...
          alert(`Policy resubmitted for review! New version: ${response.data.Version}`);
